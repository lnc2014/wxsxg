<?php
include dirname(__FILE__).'/Weixin/WxPay.Api.php';
include dirname(__FILE__).'/Weixin/WxPay.Notify.php';
define('Goods_PATH',dirname(dirname(__FILE__))); 
require_once Goods_PATH.'/Pay.php';
require_once Goods_PATH.'/User.php';
require_once Goods_PATH.'/ApiFunc.php'; 
