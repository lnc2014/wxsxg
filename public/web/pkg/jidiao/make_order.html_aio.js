define('common/js/mod/jquery-2.2.4', function(require, exports, module) {
...
define('common/js/mod/template/template', function(require, exports, module) {
      ...
      function crossStationFunc(action,delobj){
      	...
      	switch(action){
      		case 'add'://增加
                ...
                var hid_id = 'hidden_cplace' + crossNum;
                var val_id = 'cplace' + crossNum;
                var del_id = 'del' + crossNum;
                var data = {hidden_id:hid_id, val_id:val_id, del_id:del_id};
                var tempdata = crossTemp(data);
                $("#toPlaceCell").before(tempdata);
                ddCommon.BMap_Autocomplete(val_id,true,hid_id);
                crossNum++;
  				      break;
